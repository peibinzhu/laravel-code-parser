...
use PeibinLaravel\CodeParser\Exceptions\InvalidArgumentException;
use PhpParser\Node;
...
class PhpParser
{
    ...
    public function getNodeFromReflectionType(ReflectionType $reflection
    ...
    private function getTypeWithNullableOrNot(ReflectionType $reflection
    ): Node\ComplexType | Node\Identifier | Node\Name {
